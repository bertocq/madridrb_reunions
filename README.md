...
3. Since we stored the internal links (there are some externals) with the ?m=edit option, we can access the markdown version of each reunion and store in a mont_year.md file the contents under /reunions directory

> Currently the url https://madridrb.jottit.com/f%C3%BAtbol.rb_julio_2011 gives an error because the non-ascii character, content needs to be retrieved manually
